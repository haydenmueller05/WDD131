...
// ---------------------------------------------------------
// Activity 1: Sorting simple list
// ---------------------------------------------------------
...
// Descending sort using compareFn
...
// ---------------------------------------------------------
// Activity 2: Filtering simple list
// ---------------------------------------------------------

function searchListSimple(list, query) {
...
console.log("Search simple list for 'b':", searchListSimple(simpleList, "b"));
console.log("Search simple list for 'an':", searchListSimple(simpleList, "an"));


// ---------------------------------------------------------
// Activity 3: Search + Sort object list (hikes)
// ---------------------------------------------------------

function getMiles(hike) {
...
function searchHikes(list, query) {
  ...
  // Sort by distance (numeric, not alphabetical)
  const sorted = filtered.sort((a, b) => getMiles(a) - getMiles(b));
